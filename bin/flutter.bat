...
"%dart%" --disable-dart-dev --packages="%flutter_tools_dir%\.dart_tool\package_config.json" %FLUTTER_TOOL_ARGS% "%flutter_tools_dir%\bin\flutter_tools.dart" %* & "%exit_with_errorlevel%"
